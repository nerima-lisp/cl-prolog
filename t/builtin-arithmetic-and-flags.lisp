...
(deftest-queries prolog-flag-builtins ((make-rulebase))
  ...
  ((cl-prolog::current_prolog_flag ?name ?value) :set
   (((?name . cl-prolog::bounded) (?value . cl-prolog:false))
    ...
    ((?name . cl-prolog::occurs_check) (?value . cl-prolog::true))))
...
(deftest-queries arithmetic-builtins ((make-rulebase))
  ...
  ((cl-prolog::plus 2 3 ?c)     :ordered (((?c . 5))))
  ((cl-prolog::plus 2 ?b 5)     :ordered (((?b . 3))))
  ((cl-prolog::plus ?a 3 5)     :ordered (((?a . 2))))
  ((cl-prolog::plus 2 3 5)      :succeeds)
  ((cl-prolog::plus 2 3 6)      :fails)
  ((cl-prolog::plus 2 ?b ?c)    :signals)
  ((cl-prolog::plus ?a ?b ?c)   :signals)
  ((cl-prolog::plus 2 x 5)      :signals)
  ((cl-prolog::plus 2.0d0 3 ?c) :signals)
  ((cl-prolog::plus -2 3 ?c)    :ordered (((?c . 1))))
  ((cl-prolog::plus 0 0 ?c)     :ordered (((?c . 0))))
  ((cl-prolog::plus 2 -5 ?c)    :ordered (((?c . -3))))
